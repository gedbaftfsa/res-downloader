...
> 💡 **个人备注**：macOS 上首次运行如提示「无法打开」，需在「系统设置 → 隐私与安全性」中手动允许。代理端口默认 8899，如有冲突可在设置中修改。
>
> 🔧 **本人使用备注**：我将代理端口改为 **9090**（避免与本地其他服务冲突），如需复现请在设置中同步修改。
...
- 检查是否正确设置系统代理：  
  地址：127.0.0.1  
  端口：8899（若已改为 9090，请填写 9090）

### 🌐 关闭软件后无法上网？

- 手动关闭系统代理设置
- 💡 **小技巧**：可在系统代理设置中提前保存一个「关闭代理」的快捷方式，方便退出软件后快速恢复网络。
